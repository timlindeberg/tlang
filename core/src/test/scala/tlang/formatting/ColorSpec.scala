...
class ColorSpec extends UnitSpec {
  ...
  it should "adding reset should result in no color" in {
    val color = Red + RedBG + Underlined + Bold + Green + GreenBG + Yellow + YellowBG + Reset
  ...
  it should "have correct color type" in {
    ...
    (Bold + Underlined).colorType shouldBe ColorType.Modifier

    (Bold + Green).colorType shouldBe ColorType.Mixed
    (RedBG + Green).colorType shouldBe ColorType.Mixed

    (RedBG + Green + Bold + Underlined).colorType shouldBe ColorType.Mixed
  ...
  it should "determine whether a reset is needed between two colors" in {
    ...
    Bold needsResetBefore (Bold + Underlined) shouldBe false
    ...
    (GreenBG + Red + Bold) needsResetBefore (GreenBG + Red + Bold + Underlined) shouldBe false
