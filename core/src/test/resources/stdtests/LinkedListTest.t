...
Def Remove() = {
    val t = new Tester<Int>()
    val v: LinkedList<Int> = {1, 2, 3, 4, 5}
    val v2: LinkedList<Int> = {2, 3}
...
Def IndexOf() = {
    val t = new Tester<Int>()
    val v: LinkedList<Int> = {1, 2, 2, 4, 5, 1}
...
Def FirstLast() = {
    val t = new Tester<Int>()
    val v: LinkedList<Int> = {1, 2, 2, 4, 5}
...
Def MakeString() = {
    // TODO: Uncomment when string comparison works
...
Def Equals() = {
    ...
    val v1: LinkedList<Int> = {1, 2, 2, 4, 5, 1}
    val v2: LinkedList<Int> = {1, 2, 2, 4, 5, 1}
    val v3: LinkedList<Int> = {1, 2, 3, 4, 5, 1}
    val v4: LinkedList<Int> = {1, 4, 5}
...
Def Foreach() = {
    val t = new Tester<Int>()
    val v: LinkedList<Int> = { 1, 2, 3, 4, 5, 6 }
...
Def Nodes() = {
    ...
    var i = 1
    var node = v.FirstNode()
    while(node){
        val n = node
        t.AssertEquals(i++, n.Value)
        node = n.Next
    }
}
