...
object Flags {
  ...
  case object PrintOutput extends OptionalArgumentFlag {
    ...
    override def description(formatter: Formatter): String = {
      ...
      s"""
         ...
         |If no argument is given the validtests.code is printed as it looks before the final validtests.code is generated (after the lowering phase).
    ...
    override def extendedDescription(formatter: Formatter): String = {
      ...
      s"""|The --${ Magenta(flag) } flag prints the output after a given compiler phase.
          ...
          |byte validtests.code generated by the Codegenerating phase.
  ...
  case object MessageContext extends NumberFlag {
  ...
  case object ColorScheme extends JsonFlag {
    ...
    override def description(formatter: Formatter): String = {
      import formatter.formatting._
      s"""
         |Define the color scheme to use when printing error messages and validtests.code output.
    ...
    override def extendedDescription(formatter: Formatter): String = {
      ...
      s"""
         ...
         |$validKeys
         |
         |The types can be set to either an ANSI escape validtests.code, an empty string or one of the following:
         |
         |$validColors
         |
         |Example:
  ...
  // This validtests.code looks like it could be refactored to remove duplication but
