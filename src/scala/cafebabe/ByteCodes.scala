...
object ByteCodes {
  ...
  sealed abstract class ByteCode(val code: U1, se: Option[Int], l: Option[Int], tpe: Option[VerificationTypeInfo] = None) extends AbstractByteCode {
    val size       : Int         = 1
  ...
  case object ACONST_NULL     extends ByteCode(0x1, 1, 1, NullVariableInfo())
