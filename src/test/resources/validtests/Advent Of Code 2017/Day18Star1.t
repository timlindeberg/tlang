...
Def lol(a: Instr) = a.Execute(5)

val instruction = "snd"
val registers = new Int[5]
val s = [ "abc", "def", "ghi" ]

var a: Instr

if(instruction == "snd")      a = new SND(registers, s[1].ToInt())
else  a = new SET(registers, s[1][0] - 'a', s[2].ToInt())
lol(a)
...
//val instructions = new Instr[lines.Size()]
...
//	                  instruction == "jgz" ? new JGZ(registers, s[1].ToInt(), s[2].ToInt()) :
//	                  new SND(registers, -1)
//
//var pc = 0
