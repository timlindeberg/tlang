...
class Program =
	...
	var children: String[] = new String[0]
	...
	Def new(s: String) =
		...
		if(split.Size() > 1)
			val x = split[1].Split(", ")
			this.children = new String[x.Size()]
			for(var i = 0; i < x.Size(); i++)
				this.children[i] = x[i].Trim()


	Def toString() = "Program(" + this.name + ", " + weight + ") -> " + (this.parent?.name ?: "null")
