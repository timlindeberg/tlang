...
val input =`luojygedpvsthptkxiwnaorzmq
...
Def SameCharacters(s1: String, s2: String): String =
...
for(val line1 in input.Lines())
	for(val line2 in input.Lines())
		val sameChars = SameCharacters(line1, line2)
		if(sameChars.Size() == line1.Size() - 1)
			println(sameChars) // res: lufjygedpvfbhftxiwnaorzmq
			return
